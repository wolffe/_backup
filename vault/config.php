...
function ft_settings_external_load() {
    ...
    $ft['settings']['MAXSIZE']           = 65536000; // Maximum file upload size - in bytes.
    ...
    $ft['settings']['SHOWDATES']         = 'd/m/Y'; // Set to a date format to display last modified date (e.g. 'Y-m-d'). See http://dk2.php.net/manual/en/function.date.php
    $ft['settings']['FILEBLACKLIST']     = "index.php ft.css config.php index.php config.sample.php LICENSE README.markdown .DS_store .gitignore"; // Specific files that will not be shown.
    $ft['settings']['FOLDERBLACKLIST']   = "plugins js css data img"; // Specifies folders that will not be shown. No starting or trailing slashes!
    $ft['settings']['FILETYPEBLACKLIST'] = "php phtml php3 php4 php5"; // File types that are not allowed for upload.
    $ft['settings']['FILETYPEWHITELIST'] = "png jpg swf zip pdf gif html"; // Add file types here to *only* allow those types to be uploaded.
