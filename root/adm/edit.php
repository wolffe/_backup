<div class="page">
	<h1 class="edit"><?php echo ucfirst($mode); ?> post</h1>
	<span class="error-text"><?php echo $response_text; ?></span>
	<form action="admin.php?mode=<?php echo $mode; ?>&id=<?php echo $post['post_id']; ?>" method="post">
	<p>
