...
(function (d) {
	...
	d.modal.defaults = {
		...
		focus: true,
		opacity: 50,
		overlayId: "btnt-overlay",
		overlayCss: {},
		containerId: "btnt-container",
		containerCss: {},
		dataId: "btnt-data",
		dataCss: {},
		minHeight: null,
		...
		zIndex: 1E3,
		close: true,
		closeHTML: '<a class="btntCloseImg" title="Close"></a>',
		closeClass: "btnt-close",
		escClose: true,
		overlayClose: false,
		position: null,
		persist: false,
	...
	d.modal.impl = {
		...
		init: function (a, b) {
			...
			if (typeof a === "object") {
				...
				if (a.parent().parent().size() > 0) {
					a.before(d("<span></span>").attr("id", "btnt-placeholder").css({
						display: "none"
					}));
				...
				alert("btnt Error: Unsupported data type: " + typeof a);
				return c
			}
			c.create(a);
			c.open();
		...
		create: function (a) {
			...
			b.d.overlay = d("<div></div>").attr("id", b.o.overlayId).addClass("btnt-overlay").css(d.extend(b.o.overlayCss, {
				display: "none",
			...
			b.d.container = d("<div></div>").attr("id", b.o.containerId).addClass("btnt-container").css(d.extend(b.o.containerCss, {
				display: "none",
				position: "fixed",
				zIndex: b.o.zIndex + 2
			})).append(b.o.close && b.o.closeHTML ? d(b.o.closeHTML).addClass(b.o.closeClass) :
				"").appendTo(b.o.appendTo);
			b.d.wrap = d("<div></div>").attr("tabIndex", -1).addClass("btnt-wrap").css({
				height: "100%",
				outline: 0,
				width: "100%"
			}).appendTo(b.d.container);
			b.d.data = a.attr("id", a.attr("id") || b.o.dataId).addClass("btnt-data").css(d.extend(b.o.dataCss, {
				display: "none"
			})).appendTo("body");
		...
		bindEvents: function () {
			var a = this;
			d("." + a.o.closeClass).bind("click.btnt", function (b) {
				b.preventDefault();
				a.close()
			});
			a.o.modal && a.o.close && a.o.overlayClose && a.d.overlay.bind("click.btnt", function (b) {
				b.preventDefault();
				a.close()
			});
			d(document).bind("keydown.btnt", function (b) {
			...
			d(window).bind("resize.btnt", function () {
				f = a.getDimensions();
		...
		unbindEvents: function () {
			d("." + this.o.closeClass).unbind("click.btnt");
			d(document).unbind("keydown.btnt");
			d(window).unbind("resize.btnt");
			this.d.overlay.unbind("click.btnt")
		},
		fixIE: function () {
			var a = this,
				b = a.o.position;
		...
		watchTab: function (a) {
			var b = this;
			if (d(a.target).parents(".btnt-container").length > 0) {
		...
		close: function () {
			...
			if (d.isFunction(a.o.onClose) && !a.occb) {
				...
				if (a.d.placeholder) {
					var b = d("#btnt-placeholder");
					if (a.o.persist) b.replaceWith(a.d.data.removeClass("btnt-data").css("display",
						a.display));
					else {
