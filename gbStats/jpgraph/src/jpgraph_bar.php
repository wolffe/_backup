...
class BarPlot extends Plot {
    ...
    var $bar_shadow_color="#858585";
    var $bar_shadow_hsize=3,$bar_shadow_vsize=3;	
    var $valuepos='top';
    var $iPattern=-1,$iPatternDensity=80,$iPatternColor='#858585';
...
// PUBLIC METHODS	
    ...
    function SetShadow($color="#858585",$hsize=3,$vsize=3,$show=true) {
    ...
    function SetPattern($aPattern, $aColor='#858585'){
