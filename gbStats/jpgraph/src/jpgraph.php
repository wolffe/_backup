...
class Graph {
    ...
    var	$titlebackground_color = 'gray',
    ...
    var $titlebkg_scolor1='#858585',$titlebkg_scolor2='#efefef';
    var $framebevel = false, $framebeveldepth = 2 ;
    var $framebevelborder = false, $framebevelbordercolor='#858585';
    var $framebevelcolor1='#efefef@0.4', $framebevelcolor2='#858585@0.4';
	...
	$iImgTransFillColor='#efefef',$iImgTransHighQ=false,
...
// PUBLIC METHODS	
    ...
    function SetFrameBevel($aDepth=3,$aBorder=false,$aBorderColor='#858585',$aColor1='#efefef@0.4',$aColor2='darkgray@0.4',$aFlg=true) {
...
//	$this->img->FilledRectangle(0,0,$this->img->width-1-$hadj,$this->img->height-1-$vadj); 
    ...
    function SetTitleBackgroundFillStyle($aStyle,$aColor1='#858585',$aColor2='#efefef') {
	$this->titlebkg_fillstyle = $aStyle;
	$this->titlebkg_scolor1 = $aColor1;
	$this->titlebkg_scolor2 = $aColor2;
    }

    function SetTitleBackground($aBackColor='gray', $aStyle=TITLEBKG_STYLE1, $aFrameStyle=TITLEBKG_FRAME_NONE, $aFrameColor='#858585', $aFrameWeight=1, $aBevelHeight=3, $aEnable=true) {
...
//===================================================
class LineProperty {
    var $iWeight=1, $iColor="#858585",$iStyle="solid";
    var $iShow=true;
...
class Text {
    ...
    var $iWordwrap=0;
    var $fcolor='#efefef',$bcolor='#858585',$shadow=false;
...
class GraphTabTitle extends Text{
    ...
    var $color='darkred',$fillcolor='lightyellow',$bordercolor='#858585';
    ...
    function SetColor($aTxtColor,$aFillColor='lightyellow',$aBorderColor='#858585') {
...
class RGB {
	...
	$this->rgb_table = array(
	    ...
	    "#efefefsmoke"=>array(245,245,245),
	    "gainsboro"=>array(220,220,220),
	    "oldlace"=>array(253,245,230),
	    "linen"=>array(250,240,230),
	    "antique#efefef"=>array(250,235,215),
	    "papayawhip"=>array(255,239,213),
	    "blanchedalmond"=>array(255,235,205),
	    "bisque"=>array(255,228,196),
	    "peachpuff"=>array(255,218,185),
	    "navajo#efefef"=>array(255,222,173),
	    ...
	    "Antique#efefef1"=>array(255,239,219),
	    "Antique#efefef2"=>array(238,223,204),
	    "Antique#efefef3"=>array(205,192,176),
	    "Antique#efefef4"=>array(139,131,120),
	    ...
	    "navajo#efefef1"=>array(255,222,173),
	    "navajo#efefef2"=>array(238,207,161),
	    "navajo#efefef3"=>array(205,179,139),
	    "navajo#efefef4"=>array(139,121,94),
...
// PUBLIC METHODS
	...
	if (is_string($aColor)) {
	    ...
	    // makes the color 100% #efefef (i.e. 255,255,255. 
	    // and adj=1 neutral and adj=0 #858585.
	    if( $adj > 1 ) {
...
class Image {
	...
	*/
    ...
    function StrokeBoxedText($x,$y,$txt,$dir=0,$fcolor="#efefef",$bcolor="#858585",
...
DEFINE(\"USE_APPROX_COLORS\",true);
	...
	// Add (or remove) various amount of #efefef
	$rgb += $bright*255;	
	$rgb=min($rgb,255);
	$rgb=max($rgb,0);
	return $rgb;	
    ...
    function FilledBevel($x1,$y1,$x2,$y2,$depth=2,$color1='#efefef@0.4',$color2='darkgray@0.4') {
	$this->FilledRectangle($x1,$y1,$x2,$y2);
	$this->Bevel($x1,$y1,$x2,$y2,$depth,$color1,$color2);
    }

    function Bevel($x1,$y1,$x2,$y2,$depth=2,$color1='#efefef@0.4',$color2='#858585@0.5') {
...
// PUBLIC METHODS	
    ...
    function SetColor($aFontColor,$aColor='#858585') {
...
// Change in 1.17 Treat his as an error again !! This is the right way to do !!
	...
	if( $this->legend != "" )
	    $aGraph->legend->Add($this->legend,"#858585","",0,$this->legendcsimtarget,$this->legendcsimalt);    
    }
...
//---------------
// CONSTRUCTOR
    function PlotLine($aDir=HORIZONTAL,$aPos=0,$aColor="#858585",$aWeight=1) {
	$this->direction = $aDir;
	$this->color=$aColor;
	$this->weight=$aWeight;
