<?php 
 ...
 echo "<font class=stats_header>Visiting Country / Language</font><br><font class=stats_subheader>$filtershow<br>$filtershow2</font><p><hr><br>";
 ...
 while ($d = mysql_fetch_object($c)) {
 	if ($d->h) {
 		...
 		if ($sofarcount >= $start && $sofarcount <= $end) {
 			$echolater .= "<tr><td class=showstats width=5% align=left>$number.</td><td class=showstats>".format_country_language($d->h)."&nbsp;$extra2</td><td class=showstats width=5% align=right>$d->g&nbsp;Pageloads</td></tr>"; } }
 ...
 echo "<br><img src=\"graph1.php?jptitle=Country / Language Pairs (First 20)&jplegends=$graph_legends&jpdata1=$graph_data1\"><p>";
