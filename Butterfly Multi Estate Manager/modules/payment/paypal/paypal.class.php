...
class paypal_class {
   ...
   function submit_paypal_post() {
      ...
      // is redirected to paypal.
		...
		echo "<h3>You will now be redirected to the PayPal website.</h3>\n";
		echo "<form method=\"post\" name=\"paypal_form\" action=\"".$this->paypal_url."\">\n";
			foreach($this->fields as $name => $value) {
				echo "<input type=\"hidden\" name=\"$name\" value=\"$value\" />\n";
			}
			echo "<p>Property added to queue! It will be approved after payment has beed validated.</p>\n";
			echo "<ul>\n";
				echo "<li>Item name: <strong>".$this->fields['item_name']."</strong></li>\n";
				echo "<li>Amount to pay: <strong>".$this->fields['amount']." ".$this->fields['currency_code']."</strong></li>\n";
			echo "</ul>\n";
			echo "<p>Click the button below to go to PayPal and make a secure payment for your property listing.</p>\n";
			echo "<p><input type=\"submit\" value=\"Click here\" /> <img src=\"images/icon-text-paypal.png\" alt=\"\" class=\"icon\" /></p>\n";
		echo "</form>\n";
	}
