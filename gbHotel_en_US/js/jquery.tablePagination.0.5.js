 ...
 (function($){
	...
	$.fn.tablePagination = function(settings) {
		var defaults = {  
			rowsPerPage : 50,
			currPage : 1,
			optionsForRows : [5, 10, 25, 50, 100, 250],
			ignoreRows : [],
			topNav : false
		};  
      ...
      function createPaginationElements() {
        ...
        htmlBuffer.push('<div id="tablePagination">');
			htmlBuffer.push('<span id="tablePagination_perPage">');
				...
				htmlBuffer.push(' results per page');
			htmlBuffer.push('</span>');
			htmlBuffer.push('<span id="tablePagination_paginater">');
				htmlBuffer.push('<span id="tablePagination_firstPage">|&laquo;</span>');
				htmlBuffer.push('<span id="tablePagination_prevPage">&laquo;</span>');
				htmlBuffer.push(' Page ');
				htmlBuffer.push('<input id="tablePagination_currPage" type="input" value="' + currPageNumber + '" size="2">');
				htmlBuffer.push(' from <span id="tablePagination_totalPages">' + totalPages + '</span> ');
				htmlBuffer.push('<span id="tablePagination_nextPage">&raquo;</span>');
				htmlBuffer.push('<span id="tablePagination_lastPage">&raquo;|</span>');
			htmlBuffer.push('</span>');
        htmlBuffer.push('</div>');
        htmlBuffer.push('<div class="clearfix"></div>');
